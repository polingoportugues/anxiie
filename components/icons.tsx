    ...
    <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="logo-gradient" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="100%" stopColor="#C066F9" />
        </linearGradient>
      </defs>
      <path d="M16 0C10.4 0 5.33333 4.4 5.33333 10.6667C5.33333 16.9333 16 32 16 32C16 32 26.6667 16.9333 26.6667 10.6667C26.6667 4.4 21.6 0 16 0Z" fill="url(#logo-gradient)"/>
    </svg>
...
export const WaveformIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M2 13.1a1 1 0 0 0 1 0v-2.2a1 1 0 0 0-1 0v2.2" />
    <path d="M6 15a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1v4a1 1 0 0 0 0 2" />
    <path d="M10 17a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1v6a1 1 0 0 0 0 2" />
    <path d="M14 15a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1v4a1 1 0 0 0 0 2" />
    <path d="M18 13.1a1 1 0 0 0 1 0v-2.2a1 1 0 0 0-1 0v2.2" />
    <path d="M22 11.5a1 1 0 0 0 1-1v0a1 1 0 0 0-1-1v0a1 1 0 0 0 0 2" />
  </svg>
);
